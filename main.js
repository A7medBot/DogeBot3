...
const starts = async (DogeXeonOP = new WAConnection()) => {
	...
	console.log(color('\n> YT CHANNEL: A7med_Xd ','silver'))
console.log(color('> GITHUB: A7medbot ','silver'))
console.log(color('> WA NUMBER: +9647717555198 ','silver'))
console.log(color('  AĦMED Bot Inc. 2022','mediumseagreen'))
    console.log(color('<>','red'), color('I Wrote This Script By Myself!\nNote, The Script Is Encrypted, So You Wont Be Able To Recode, If You Wish To Decrypted Script Contact The Developer', 'yellow'))
    console.log(color('<>','red'), color('Source Code Version: 3.0', 'aqua'))
    console.log(color('<>','red'), color('But? Error? Suggestion? Visit Here:', 'aqua'), color('https://wa.me/9647717555198'))
	...
	DogeXeonOP.browserDescription = [ 'Subscribe AĦMED', 'chrome', '3.0' ]
    DogeXeonOP.on('qr', () => {
    ...
    DogeXeonOP.sendMessage(`9647717555198@s.whatsapp.net`, `Thanks bro, your bot is working on my whatsapp number ez😂`, MessageType.extendedText)
...
DogeXeonOP.on("group-participants-update", async (anu) => {
    ...
    try {
      ...
      time_welc = moment.tz('Middle East/Iraq').format('DD/MM/YYYY')
      time_wel = moment.tz('Middle East/Iraq').format("hh:mm")
